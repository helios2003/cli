...
export const optimizeFlags = () => {
  return {
    ...
    ignore: Flags.string({char: 'i', default: Object.values(DisableOptimizations), options: Object.values(DisableOptimizations), multiple: true, description: 'schema should be ignored from the optimization process'}),
